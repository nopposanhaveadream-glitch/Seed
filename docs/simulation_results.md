...
**2026-05-02 追記**: 5月上旬振り返り後の事実確認で、並走時間 約18時間24分、重複ステップ 12,890件、step後退 8,846件と判明。さらに、PIDファイルによる防御が 4/18 14:50 にすり抜けた事象も確認された（原因はログから判定不能）。「再発リスクをゼロに」という当初評価は、4/18 のすり抜けを含めると正確ではない。詳細は `docs/known_issues_2026-05-01.md` を主出典として参照。
